...
if (!function_exists('m_layout_nav')) {
    ...
    {
        $items = [
            'panel' => ['url' => 'index.php', 'icon' => 'fa-chart-line', 'label' => 'سیگنال کریپتو'],
            'settings' => ['url' => 'settings.php', 'icon' => 'fa-sliders', 'label' => 'تنظیمات'],
        ];
        ?>
<nav class="topnav glass-3d">
    <div class="topnav__brand">
        <span class="brand-mark" aria-hidden="true"><i class="fa-solid fa-cube"></i></span>
        <span class="brand-text">پنل هوشمند <b>میلانو</b></span>
...
<footer class="studio-footer">
    <div class="studio-footer__inner">
        ...
        <div class="studio-footer__text">
            ...
            <p class="studio-line">طراحی و توسعهٔ سامانه‌های هوشمند بازار و انبار</p>
