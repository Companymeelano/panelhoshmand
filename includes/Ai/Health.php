...
final class Health
{
    ...
    public static function probes(): array
    {
        return [
            ...
            'byteplus' => ['method' => 'GET', 'path' => '/models', 'auth' => 'bearer', 'ok_codes' => [200], 'deep' => true],
            'stability' => ['method' => 'GET', 'path' => '/v1/user/account', 'auth' => 'bearer', 'ok_codes' => [200], 'deep' => true],
            'deepai' => ['method' => 'GET', 'path' => '/chat', 'auth' => 'header_api_key', 'ok_codes' => [200, 400, 405], 'deep' => false],
            'fal' => ['method' => 'GET', 'path' => '/fal-ai/flux/dev', 'auth' => 'fal_key', 'ok_codes' => [200, 400, 401, 405], 'deep' => false],
            'kling' => ['method' => 'GET', 'path' => '/v1/images/generations', 'auth' => 'bearer', 'ok_codes' => [200, 400, 401, 404, 405], 'deep' => false],
            'piapi' => ['method' => 'GET', 'path' => '/v1/mj/account/list', 'auth' => 'header_x_api_key', 'ok_codes' => [200], 'deep' => true],
        ];
    }
