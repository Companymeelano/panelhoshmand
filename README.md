...
**ویژگی‌های نسخه جدید:**
- 🧭 **ویزارد ۵ مرحله‌ای** (اطلاعات ← بازار ← قیمت‌گذاری ← تصویر ← ثبت)؛ بدون اسکرول طولانی، هر گام دکمه «تأیید و ادامه» دارد
- 📱 **بهینه موبایل:** حذف افکت‌های سنگین در گوشی (رفع هنگ اسکرول)، ناوبری چسبان، کاملاً لمسی
- 🎨 **تولید واقعی موکاپ تبلیغاتی** با هوش مصنوعی (Flux/Turbo) + تبدیل خودکار به WebP در ابعاد 768×768
- 💰 استعلام ترب و دیجی‌کالا، محاسبه خودکار حاشیه سود، خلاصه ثبت قبل از ذخیره
